                        ...
                        <div class="container">
                            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
                                <div class="slider-text-inner desc">
                                    ...
                                    <p class="colorlib-lead">Designed with love by the fine folks at <a href="#"
                                            target="_blank">Lawfirm</a></p>
                                </div>
                            </div>
                        </div>
                    </li>
        ...
        <div id="colorlib-blog">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="colorlib-blog animate-box">
                            <a href="#"><img class="img-responsive" src="images/blog-2.jpg"
                                    alt=""></a>
                            <div class="blog-text">
                                <h3><a href="#">Child Abuse Cases Are Our First Priority</a></h3>
                                <p class="meta"><span>Jan 5, 2017</span> | <span>3 Comments</span></p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="colorlib-blog animate-box">
                            <a href="#"><img class="img-responsive" src="images/blog-3.jpg"
                                    alt=""></a>
                            <div class="blog-text">
                                <h3><a href="#">Child Abuse Cases Are Our First Priority</a></h3>
                                <p class="meta"><span>Jan 5, 2017</span> | <span>3 Comments</span></p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="colorlib-blog animate-box">
                            <a href="#"><img class="img-responsive" src="images/blog-1.jpg"
                                    alt=""></a>
                            <div class="blog-text">
                                <h3><a href="#">Child Abuse Cases Are Our First Priority</a></h3>
                                <p class="meta"><span>Jan 5, 2017</span> | <span>3 Comments</span></p>
